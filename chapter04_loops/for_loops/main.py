...
1. for 반복문의 기본 개념 :
    정해진 구간 혹은 집합 내의 요소들을 순서대로 꺼내면서 반복작업을 수행.
...
# print()
#
# for i in range(10): # 현재 상황에서의 반복횟수는 10번인데, 여기서 중요한 것은 시작 지점이 0이라는 것.
#     print(i+1)
...
'''
        range() 함수의 응용:
            ...
            종료값 : 명시하지 않으면 끝까지 진행
            증감값 : 생략가능, 생략할 경우에 1씩 증가           -> index에서의 slicing 개념과 유사
...
#     print(i)                    # 종료값 바로 앞까지 출력이 이루어짐을 확인할 수 있습니다.
...
#
# print(len(name))
# print(type(len(name)))  # int!!
#
# #(2) enhanced for loop 를 통한 방식
...
#     ex) str, list, tuple, set, dict -> 현재 저희는 str만 기준으로 수업 중이었습니ㅏㄷ.
#
# 주의사항 :
#     if 조건문과 마찬가지로 들여쓰기 (indented writing)이 매우 주의합니다.
#
#
# 문자열에서 특정 문자의 개수 세기
